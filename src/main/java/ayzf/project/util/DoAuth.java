...
public class DoAuth
{
    ...
    public static String execute(String activityToken, long id)
    {
        ...
        try
        {
            ...
            PreparedStatement userStatement = conn.prepareStatement("SELECT * FROM " + Main.configLoader.getProperty("SQL_FORM") + " WHERE " + Main.configLoader.getProperty("SQL_ROW_ID") + " = ?");
